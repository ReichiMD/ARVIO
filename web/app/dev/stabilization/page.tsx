...
export default async function Page({ searchParams }: { searchParams: Promise<{ mobile?: string; sourcePlayback?: string }> }) {
  ...
  return <StabilizationFixture testLiveUrl={process.env.ARVIO_TEST_LIVE_URL} useSourceUrls={(await searchParams).sourcePlayback === "1"} />;
}
